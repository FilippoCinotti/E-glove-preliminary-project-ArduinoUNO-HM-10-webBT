...
function draw() {
  ...
  text('MeCFES', 960, 10);
  if (isConnected) {
    image(imgEglove_On, 200, 70);
    fill(115);
    text('Connesso!', 280, 160);
  } else {
    image(imgEglove_Off, 200, 70);
    text('Disconnesso :/', 280, 160);
  }
  
  if (isConnectedMC) {
    image(imgMC_On, 860, 70);
    text('Connesso!', 960, 160);
  } else {
    image(imgMC_Off, 860, 70);
    text('Disconnesso :/', 960, 160);
  }
}